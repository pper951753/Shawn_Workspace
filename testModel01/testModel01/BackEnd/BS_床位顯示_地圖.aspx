       ...
       <div style="width: 1235px; height: 847px; margin: 0 auto 0 auto">
        <table class="nav-justified" style="background-image: url(../pic/床位_地圖85趴.jpg); width: 100%">
            ...
            <tr>
                ...
                <td style="height: 45px; " colspan="2"><button class="btn" style="background-color:rgba(100%,100%,100%, 1); height: 40px; width: 80px;"></button></td>
                <td style="height: 45px; width: 88px;"><button class="btn" style="background-color:rgba(100%,100%,100%, 1); height: 40px; width: 80px;"></button></td>
