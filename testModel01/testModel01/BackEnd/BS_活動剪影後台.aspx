...
<asp:Content ID="Content2" ContentPlaceHolderID="BS_BodyContent" runat="server">
    ...
    <a id="aa" data-toggle="modal" data-target="#myModal">
        <img class="myimag_1" src="../pic/康欣_照片/外觀/outlook_L (14).jpg" />
    </a>
    ...
    <div class="modal fade" id="myModal" aria-hidden="true">
        <div class="modal-dialog modal-content">
            ...
            <img style="align-items:center" id="img1" src="../pic/康欣_照片/外觀/outlook_L (10).jpg"  />
        </div>
    </div>
    <!--這是被點選的圖片-->
                ...
                <asp:ListView ID="ListView_outlook" runat="server">
                    <ItemTemplate>
                        <div class=" mydiv_1 " align="center">
                            ...
                            <div align="center">
                                <a data-toggle="modal" data-target="#myModal" onclick="myfuction()">
